...
import { ArrowLeft, Clock, User, Mail, MapPin, Tag } from "lucide-react";
import { formatDateTime, getStatusColor, getPriorityColor } from "@/lib/utils";
import { AdminComplaintActions } from "@/components/admin/admin-complaint-actions";
...
export default async function AdminComplaintDetailPage({
  ...
  // Get departments and officers for assignment
        ...
        <div className="space-y-6 lg:col-span-2">
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              {/* Assignment Info */}
              {(complaint.departments || complaint.assigned_officer) && (
